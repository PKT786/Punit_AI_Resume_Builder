...
st.set_page_config(page_title="Résumé Studio — Premium ATS Resume Builder", page_icon="🖋️", layout="centered")
...
# ======================================================= LANDING CONTENT ==
def render_landing():
    preview_b64 = _img_b64(os.path.join(APP_DIR, "resume_preview.png"))
    ...
    st.markdown(
        ...
        .preview-wrap {{
            display: flex; align-items: center; gap: 30px; margin-bottom: 32px; flex-wrap: wrap;
        }}
        ...
        .steps-row {{ display: flex; gap: 14px; margin-bottom: 30px; flex-wrap: wrap; }}
