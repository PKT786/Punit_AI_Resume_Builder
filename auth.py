...
def _render_features():
    """
    The 'what is this site and why should I care' section — lives on the
    login/signup page itself (not after login) so it's the first thing a
    new visitor sees, before they've committed to signing up.
    """
    ...
    st.markdown(
        ...
        .signin-eyebrow {{
            text-align: center; color: {BRASS}; font-size: 11px; font-weight: 700;
            letter-spacing: 2px; text-transform: uppercase; margin: 4px 0 2px;
        }}
        </style>
    ...
    st.divider()
    st.markdown('<div class="signin-eyebrow">Sign in to get started</div>', unsafe_allow_html=True)
